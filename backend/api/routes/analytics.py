...
async def get_analytics_dashboard(
    ...
    return {
        ...
        "consultation_statuses": {item["_id"]: item["count"] for item in consultation_statuses},
        "top_conditions": [{"condition": item["_id"], "count": item["count"]} for item in top_conditions],
