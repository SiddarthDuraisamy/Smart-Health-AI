...
class HealthRiskPredictor:
    ...
    def prepare_features(self, patient_data: Dict[str, Any]) -> np.ndarray:
        ...
        has_diabetes_history = any('diabetes' in condition['condition'].lower() for condition in medical_history)
        has_hypertension_history = any('hypertension' in condition['condition'].lower() for condition in medical_history)
        has_heart_disease_history = any('heart' in condition['condition'].lower() for condition in medical_history)
