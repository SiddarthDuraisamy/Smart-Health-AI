...
get_patient_user = require_role(UserRole.PATIENT)
get_doctor_user = require_role(UserRole.DOCTOR)
get_admin_user = require_role(UserRole.ADMIN)
get_medical_user = require_roles([UserRole.DOCTOR, UserRole.ADMIN])
